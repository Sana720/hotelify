...
import { ArrowRight, Mail, Lock, ShieldCheck, UserCircle2, Eye, EyeOff } from "lucide-react";
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group/input">
                            ...
                            <Input
                                ...
                                placeholder="••••••••"
                                className="pl-12 pr-12 h-14 bg-white/[0.02] border-white/5 rounded-2xl focus:ring-blue-500/20 focus:border-blue-500/40 transition-all text-white placeholder:text-zinc-800 font-medium"
                                required
                            />
                            <button
                                type="button"
